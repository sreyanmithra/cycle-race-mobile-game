...
function setup(){
  ...
  gameOver=createSprite(width/2,width-450)
...
function draw(){
  ...
  textSize(18)
  fill("skyBlue")
  text("Distance:  "+racerMoving,width-140,height-440);
...
function pinkCyclists(){
  ...
  opponentPink=createSprite(width-0,Math.round(random(height-40,height-400)))
...
function yellowCyclists(){
  ...
  opponentYellow=createSprite(width-0,Math.round(random(height-40,height-400)))
...
function redCyclists(){
  ...
  opponentRed=createSprite(width-0,Math.round(random(height-40,height-400)))
...
function spawnObstcle1(){
  obstacle1=createSprite(width-0,Math.round(random(height-40,height-400)))
...
function spawnObstcle2(){
  obstacle2=createSprite(width-0,Math.round(random(height-40,height-400)))
...
function spawnObstcle3(){
  obstacle3=createSprite(width-0,Math.round(random(height-40,height-400)))
